...
```{r plot-singler-comparison-before-vs-after-integration, fig.width = 18, fig.height = 6, fig.fullwidth = TRUE, echo=TRUE}
...
p1.after <- DimPlot(seurat_obj, reduction = redution_value, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")) 
...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = "ID", group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")))
...
## Fine cell type annotations and fractions per condition1
...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value1, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")))
...
## Fine cell type annotations and fractions per condition2
...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value2, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")))
ggsave(file = name, width = 15, height = 6, device = "png")
```
...
## Fine cell type annotations and fractions per condition3
...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value3, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")))
ggsave(file = name, width = 15, height = 6, device = "png")
```
