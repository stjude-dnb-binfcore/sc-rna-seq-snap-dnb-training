...
name <- paste0(plots_dir, "/", glue::glue("plot-singler-fine-condition.png"))
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")))
...
name <- paste0(plots_dir, "/", glue::glue("plot-singler-fine-condition-fractions.png"))
