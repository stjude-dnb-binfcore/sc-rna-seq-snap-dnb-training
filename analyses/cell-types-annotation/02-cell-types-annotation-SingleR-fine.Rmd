...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = "ID", group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
...
p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value1, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")) +
...
if (!is.null(condition_value2)) {
  ...
  p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value2, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")) +
...
if (!is.null(condition_value3)) {
  ...
  p1.after <- print(DimPlot(seurat_obj, reduction = redution_value, split.by = condition_value3, group.by = 'singler.fine', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Fine cell type annotations: {integration_method} integration")) +
