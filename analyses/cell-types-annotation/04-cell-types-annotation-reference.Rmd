...
print(knitr::kable(tables1, caption = "Reference cell type annotations"))
cat("  \n</div>  \n")
cat("  \n\\pagebreak  \n")
```
...
cat("  \n<div align=\"center\" style=\"font-size:80%\">  \n")
print(knitr::kable(tables1, caption = "Reference cell type annotations per ID"))
cat("  \n</div>  \n")
cat("  \n\\pagebreak  \n")
```
...
p1.after <- DimPlot(seurat_obj.query, reduction = redution_value, group.by = 'predicted.id', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + ggtitle(glue::glue("Reference cell type annotations: {integration_method} integration")) 
...
p1.after <- print(DimPlot(seurat_obj.query, reduction = redution_value, split.by = "ID", group.by = 'predicted.id', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
...
p1.after <- print(DimPlot(seurat_obj.query, reduction = redution_value, split.by = condition_value1, group.by = 'predicted.id', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Reference cell type annotations: {integration_method} integration")) +
...
if (!is.null(condition_value2)) {
  ...
  p1.after <- print(DimPlot(seurat_obj.query, reduction = redution_value, split.by = condition_value2, group.by = 'predicted.id', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Reference cell type annotations: {integration_method} integration")) +
...
if (!is.null(condition_value3)) {
  ...
  p1.after <- print(DimPlot(seurat_obj.query, reduction = redution_value, split.by = condition_value3, group.by = 'predicted.id', label = TRUE, repel = TRUE, label.size = 2.5, cols = palette) + 
                    ggtitle(glue::glue("Reference cell type annotations: {integration_method} integration")) +
