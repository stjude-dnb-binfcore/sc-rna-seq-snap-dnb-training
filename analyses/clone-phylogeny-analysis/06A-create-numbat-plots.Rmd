...
`numbat_obj$clone_post` contains the probability of a cell belong to a clone with aneuploidy (aka being a malignant cell). We can visualize the probability values in a expression-based embedding:
