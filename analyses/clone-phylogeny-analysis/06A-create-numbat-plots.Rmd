...
p_cnv <- print(ggplot(plot_data_p_cnv, aes(x = UMAP_1, y = UMAP_2, color = Feature)) +
...
p_cnv_x <- print(ggplot(plot_data, aes(x = UMAP_1, y = UMAP_2, color = Feature)) +
  geom_point(alpha = 0.8) +  # Adjust transparency if needed
  scale_color_gradient2(low = 'royalblue', mid = 'white', high = 'red3', midpoint = 0.5, name = 'Posterior') +
  ggtitle("Expression") +
  theme_Publication () +
...
p_cnv_y <- print(ggplot(plot_data, aes(x = UMAP_1, y = UMAP_2, color = Feature)) +
  geom_point(alpha = 0.8) +  # Adjust transparency if needed
  scale_color_gradient2(low = 'royalblue', mid = 'white', high = 'red3', midpoint = 0.5, name = 'Posterior') +
  ggtitle("Joint") +
  theme_Publication () +
...
```{r plot-7, fig.width = 20, fig.height = 8, fig.fullwidth = TRUE, echo=TRUE}
...
```{r plot-9, fig.width = 15, fig.height = 6, fig.fullwidth = TRUE, echo=TRUE}
