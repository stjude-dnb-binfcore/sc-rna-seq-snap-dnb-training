...
```{r create-palette-timepoint, echo=TRUE}
# Read color palette
palette_timepoint_df <- readr::read_tsv(timepoint_palette_file, guess_max = 100000, show_col_types = FALSE) 

# Define and order palette
palette_timepoint <- palette_timepoint_df$hex_codes 
names(palette_timepoint) <- palette_timepoint_df$timepoint
```
