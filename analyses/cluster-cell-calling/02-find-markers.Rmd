...
We save the table with all markers for each cluster here: ./results/02_find_markers/Res_`r {resolution_list}`_Markers_all.tsv.

```{r find-markers, echo=TRUE}
# Assuming you want markers only for clusters 1 and 2
