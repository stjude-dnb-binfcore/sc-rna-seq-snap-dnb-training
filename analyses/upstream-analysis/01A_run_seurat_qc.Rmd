...
seurat_qc_plots_dir <- file.path(plots_dir, "01_Seurat_qc") 
...
seurat_results_dir <- file.path(module_results_dir, paste0("01_Seurat_qc"))
...
# Read in 10x data 
We will first read read counts in the 10x data.
