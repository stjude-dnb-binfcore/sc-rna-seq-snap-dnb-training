...
seurat_results_dir <- file.path(analysis_dir, "results", "01_Seurat_qc") 
...
We will load the raw seurat object as generated in the `01_seurat_alignment_qc.Rmd` step of the pipeline. We will run dimensionality reductions and convert to single cell experiments.
...
print(knitr::kable(tables1, caption = "Summary of doublets detection per sample"))
cat("  \n</div>  \n")
cat("  \n\\pagebreak  \n")
```
